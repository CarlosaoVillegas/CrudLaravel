    <div class="form-group">
        ...
        title="Formato de RFC incorrecto"
         class="form-control <?php echo e($errors->has('rfc')?'is-invalid':''); ?>"  name="rfc" id="rfc" 
            value="<?php echo e(isset($cliente->rfc)?$cliente->rfc:old('rfc')); ?>">
        <?php endif; ?>
    </div>
    ...
    <div class="form-group">
        ...
        <label for="Nombre"
         class="control.label"> <?php echo e('Nombre'); ?></label>
        <input type="text"
        placeholder="Introduzca Nombre" maxlength="50"
        class="form-control <?php echo e($errors->has('nombre')?'is-invalid':''); ?>" name="nombre" id="nombre" 
    ...
    <div class="form-group">
        ...
        class="form-control <?php echo e($errors->has('edad')?'is-invalid':''); ?>" name="edad" id="edad" 
    ...
    <div class="form-group">
        ...
        class="control.label"> <?php echo e('Id Ciudad'); ?></label>
        <input type="number"  placeholder="Introduzca IdCiudad" class="form-control <?php echo e($errors->has('idciudad')?'is-invalid':''); ?>" name="idciudad" id="idciudad" 
  ...
  <?php /**PATH C:\wamp64\www\proyectolaravel2\resources\views/cliente/form.blade.php ENDPATH**/ ?>